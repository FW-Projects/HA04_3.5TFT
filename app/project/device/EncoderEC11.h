...
#define TEMP_EC11_A_GPIO_PORT    GPIOA
#define TEMP_EC11_A_GPIO_PIN     GPIO_PINS_8

#define TEMP_EC11_B_GPIO_PORT    GPIOA
#define TEMP_EC11_B_GPIO_PIN     GPIO_PINS_11



#define TEMP_EC11_KEY_GPIO_PORT  GPIOC
#define TEMP_EC11_KEY_GPIO_PIN   GPIO_PINS_9

#define AIR_EC11_A_GPIO_PORT    GPIOF
#define AIR_EC11_A_GPIO_PIN     GPIO_PINS_6


#define AIR_EC11_B_GPIO_PORT    GPIOF
#define AIR_EC11_B_GPIO_PIN     GPIO_PINS_7



#define AIR_EC11_KEY_GPIO_PORT  GPIOA
#define AIR_EC11_KEY_GPIO_PIN   GPIO_PINS_12
